...
*/
SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM urn:oid:2.16.840.1.113883.3.117.1.7.1.424 AS NonElectiveEncounter) WHERE (((NonElectiveEncounter.relevantPeriod.high - NonElectiveEncounter.relevantPeriod.low) <= 120) AND NonElectiveEncounter.relevantPeriod.high BETWEEN (SELECT low FROM @Measurement_Period, SELECT high FROM @Measurement_Period)) AS NonElectiveEncounter) WHERE EXISTS (SELECT * FROM (NonElectiveEncounter.diagnoses AS Diagnosis) WHERE ((Diagnosis.rank = 1) AND (Diagnosis.code IN urn:oid:2.16.840.1.113883.3.117.1.7.1.212 OR Diagnosis.code IN urn:oid:2.16.840.1.113883.3.117.1.7.1.247))) AS AllStrokeEncounter) WHERE (floor(months_between(to_date(SELECT birthDatetime FROM SELECT * FROM Patient), SELECT low FROM AllStrokeEncounter.relevantPeriod) / 12) >= 18) AS EncounterWithAge) WHERE EXISTS (SELECT * FROM (EncounterWithAge.diagnoses AS Diagnosis) WHERE (Diagnosis.code IN urn:oid:2.16.840.1.113883.3.117.1.7.1.247 AND (Diagnosis.rank = 1))) AS IschemicStrokeEncounter) WHERE ((((IschemicStrokeEncounter.dischargeDisposition IN urn:oid:2.16.840.1.113883.3.117.1.7.1.87 OR IschemicStrokeEncounter.dischargeDisposition IN urn:oid:2.16.840.1.113883.3.117.1.7.1.308) OR IschemicStrokeEncounter.dischargeDisposition IN urn:oid:2.16.840.1.113883.3.117.1.7.1.309) OR IschemicStrokeEncounter.dischargeDisposition IN urn:oid:2.16.840.1.113883.3.117.1.7.1.209) OR IschemicStrokeEncounter.dischargeDisposition IN urn:oid:2.16.840.1.113883.3.117.1.7.1.207) UNION SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM urn:oid:2.16.840.1.113883.3.117.1.7.1.424 AS NonElectiveEncounter) WHERE (((NonElectiveEncounter.relevantPeriod.high - NonElectiveEncounter.relevantPeriod.low) <= 120) AND NonElectiveEncounter.relevantPeriod.high BETWEEN (SELECT low FROM @Measurement_Period, SELECT high FROM @Measurement_Period)) AS NonElectiveEncounter) WHERE EXISTS (SELECT * FROM (NonElectiveEncounter.diagnoses AS Diagnosis) WHERE ((Diagnosis.rank = 1) AND (Diagnosis.code IN urn:oid:2.16.840.1.113883.3.117.1.7.1.212 OR Diagnosis.code IN urn:oid:2.16.840.1.113883.3.117.1.7.1.247))) AS AllStrokeEncounter) WHERE (floor(months_between(to_date(SELECT birthDatetime FROM SELECT * FROM Patient), SELECT low FROM AllStrokeEncounter.relevantPeriod) / 12) >= 18) AS EncounterWithAge) WHERE EXISTS (SELECT * FROM (EncounterWithAge.diagnoses AS Diagnosis) WHERE (Diagnosis.code IN urn:oid:2.16.840.1.113883.3.117.1.7.1.247 AND (Diagnosis.rank = 1))) AS IschemicStrokeEncounter, WITH SELECT * FROM urn:oid:1.3.6.1.4.1.33895.1.3.0.45 UNION SELECT * FROM urn:oid:1.3.6.1.4.1.33895.1.3.0.45 AS coalesce(SELECT low FROM IF (NOT ComfortMeasure.relevantDatetime IS NULL) THEN (SELECT struct(ComfortMeasure.relevantDatetime as high, ComfortMeasure.relevantDatetime as low) _val) ELSE (IF (NOT ComfortMeasure.relevantPeriod IS NULL) THEN (ComfortMeasure.relevantPeriod) ELSE (NULL)), ComfortMeasure.authorDatetime) BETWEEN (SELECT low FROM LET SELECT * FROM (SELECT * FROM urn:oid:2.16.840.1.113762.1.4.1111.143 AS LastObs) WHERE (LastObs.relevantPeriod.high BETWEEN (SELECT low FROM SELECT struct(Visit.relevantPeriod.low as high, (Visit.relevantPeriod.low - /*{Operator: _macros_sparksql.Quantity with children: []}*/) as low) _val, SELECT high FROM SELECT struct(Visit.relevantPeriod.low as high, (Visit.relevantPeriod.low - /*{Operator: _macros_sparksql.Quantity with children: []}*/) as low) _val) AND NOT Visit.relevantPeriod.low IS NULL) ORDER BY relevantPeriod.high ASC, SELECT * FROM (SELECT * FROM urn:oid:2.16.840.1.113883.3.117.1.7.1.292 AS LastED) WHERE (LastED.relevantPeriod.high BETWEEN (SELECT low FROM SELECT struct(VisitStart as high, (VisitStart - /*{Operator: _macros_sparksql.Quantity with children: []}*/) as low) _val, SELECT high FROM SELECT struct(VisitStart as high, (VisitStart - /*{Operator: _macros_sparksql.Quantity with children: []}*/) as low) _val) AND NOT VisitStart IS NULL) ORDER BY relevantPeriod.high ASCSELECT SELECT struct(SELECT high FROM Visit.relevantPeriod as high, coalesce(SELECT low FROM SELECT relevantPeriod FROM EDVisit, VisitStart) as low) _val FROM (IschemicStrokeEncounter AS Visit, coalesce(SELECT low FROM SELECT relevantPeriod FROM ObsVisit, SELECT low FROM Visit.relevantPeriod)), SELECT high FROM LET SELECT * FROM (SELECT * FROM urn:oid:2.16.840.1.113762.1.4.1111.143 AS LastObs) WHERE (LastObs.relevantPeriod.high BETWEEN (SELECT low FROM SELECT struct(Visit.relevantPeriod.low as high, (Visit.relevantPeriod.low - /*{Operator: _macros_sparksql.Quantity with children: []}*/) as low) _val, SELECT high FROM SELECT struct(Visit.relevantPeriod.low as high, (Visit.relevantPeriod.low - /*{Operator: _macros_sparksql.Quantity with children: []}*/) as low) _val) AND NOT Visit.relevantPeriod.low IS NULL) ORDER BY relevantPeriod.high ASC, SELECT * FROM (SELECT * FROM urn:oid:2.16.840.1.113883.3.117.1.7.1.292 AS LastED) WHERE (LastED.relevantPeriod.high BETWEEN (SELECT low FROM SELECT struct(VisitStart as high, (VisitStart - /*{Operator: _macros_sparksql.Quantity with children: []}*/) as low) _val, SELECT high FROM SELECT struct(VisitStart as high, (VisitStart - /*{Operator: _macros_sparksql.Quantity with children: []}*/) as low) _val) AND NOT VisitStart IS NULL) ORDER BY relevantPeriod.high ASCSELECT SELECT struct(SELECT high FROM Visit.relevantPeriod as high, coalesce(SELECT low FROM SELECT relevantPeriod FROM EDVisit, VisitStart) as low) _val FROM (IschemicStrokeEncounter AS Visit, coalesce(SELECT low FROM SELECT relevantPeriod FROM ObsVisit, SELECT low FROM Visit.relevantPeriod))))
/*
...
*/
SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM urn:oid:2.16.840.1.113883.3.117.1.7.1.424 AS NonElectiveEncounter) WHERE (((NonElectiveEncounter.relevantPeriod.high - NonElectiveEncounter.relevantPeriod.low) <= 120) AND NonElectiveEncounter.relevantPeriod.high BETWEEN (SELECT low FROM @Measurement_Period, SELECT high FROM @Measurement_Period)) AS NonElectiveEncounter) WHERE EXISTS (SELECT * FROM (NonElectiveEncounter.diagnoses AS Diagnosis) WHERE ((Diagnosis.rank = 1) AND (Diagnosis.code IN urn:oid:2.16.840.1.113883.3.117.1.7.1.212 OR Diagnosis.code IN urn:oid:2.16.840.1.113883.3.117.1.7.1.247))) AS AllStrokeEncounter) WHERE (floor(months_between(to_date(SELECT birthDatetime FROM SELECT * FROM Patient), SELECT low FROM AllStrokeEncounter.relevantPeriod) / 12) >= 18) AS EncounterWithAge) WHERE EXISTS (SELECT * FROM (EncounterWithAge.diagnoses AS Diagnosis) WHERE (Diagnosis.code IN urn:oid:2.16.840.1.113883.3.117.1.7.1.247 AND (Diagnosis.rank = 1))) AS IschemicStrokeEncounter, WITH SELECT * FROM urn:oid:2.16.840.1.113762.1.4.1110.52 AS Pharmacological.authorDatetime BETWEEN (SELECT low FROM IschemicStrokeEncounter.relevantPeriod, SELECT high FROM IschemicStrokeEncounter.relevantPeriod))
/*
...
*/
SELECT * FROM (SELECT * FROM urn:oid:2.16.840.1.113762.1.4.1110.62 AS NoAntithromboticDischarge) WHERE (NoAntithromboticDischarge.negationRationale IN urn:oid:2.16.840.1.113883.3.117.1.7.1.473 OR NoAntithromboticDischarge.negationRationale IN urn:oid:2.16.840.1.113883.3.117.1.7.1.93)
/*
...
*/
SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM urn:oid:2.16.840.1.113883.3.117.1.7.1.424 AS NonElectiveEncounter) WHERE (((NonElectiveEncounter.relevantPeriod.high - NonElectiveEncounter.relevantPeriod.low) <= 120) AND NonElectiveEncounter.relevantPeriod.high BETWEEN (SELECT low FROM @Measurement_Period, SELECT high FROM @Measurement_Period)) AS NonElectiveEncounter) WHERE EXISTS (SELECT * FROM (NonElectiveEncounter.diagnoses AS Diagnosis) WHERE ((Diagnosis.rank = 1) AND (Diagnosis.code IN urn:oid:2.16.840.1.113883.3.117.1.7.1.212 OR Diagnosis.code IN urn:oid:2.16.840.1.113883.3.117.1.7.1.247))) AS AllStrokeEncounter) WHERE (floor(months_between(to_date(SELECT birthDatetime FROM SELECT * FROM Patient), SELECT low FROM AllStrokeEncounter.relevantPeriod) / 12) >= 18) AS EncounterWithAge) WHERE EXISTS (SELECT * FROM (EncounterWithAge.diagnoses AS Diagnosis) WHERE (Diagnosis.code IN urn:oid:2.16.840.1.113883.3.117.1.7.1.247 AND (Diagnosis.rank = 1))) AS IschemicStrokeEncounter, WITH SELECT * FROM urn:oid:2.16.840.1.113762.1.4.1110.62 AS DischargeAntithrombotic.authorDatetime BETWEEN (SELECT low FROM IschemicStrokeEncounter.relevantPeriod, SELECT high FROM IschemicStrokeEncounter.relevantPeriod))
/*
...
*/
SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM urn:oid:2.16.840.1.113883.3.117.1.7.1.424 AS NonElectiveEncounter) WHERE (((NonElectiveEncounter.relevantPeriod.high - NonElectiveEncounter.relevantPeriod.low) <= 120) AND NonElectiveEncounter.relevantPeriod.high BETWEEN (SELECT low FROM @Measurement_Period, SELECT high FROM @Measurement_Period)) AS NonElectiveEncounter) WHERE EXISTS (SELECT * FROM (NonElectiveEncounter.diagnoses AS Diagnosis) WHERE ((Diagnosis.rank = 1) AND (Diagnosis.code IN urn:oid:2.16.840.1.113883.3.117.1.7.1.212 OR Diagnosis.code IN urn:oid:2.16.840.1.113883.3.117.1.7.1.247))) AS AllStrokeEncounter) WHERE (floor(months_between(to_date(SELECT birthDatetime FROM SELECT * FROM Patient), SELECT low FROM AllStrokeEncounter.relevantPeriod) / 12) >= 18) AS EncounterWithAge) WHERE EXISTS (SELECT * FROM (EncounterWithAge.diagnoses AS Diagnosis) WHERE (Diagnosis.code IN urn:oid:2.16.840.1.113883.3.117.1.7.1.247 AND (Diagnosis.rank = 1))) AS IschemicStrokeEncounter, WITH SELECT * FROM (SELECT * FROM urn:oid:2.16.840.1.113762.1.4.1110.62 AS NoAntithromboticDischarge) WHERE (NoAntithromboticDischarge.negationRationale IN urn:oid:2.16.840.1.113883.3.117.1.7.1.473 OR NoAntithromboticDischarge.negationRationale IN urn:oid:2.16.840.1.113883.3.117.1.7.1.93) AS NoDischargeAntithrombotic.authorDatetime BETWEEN (SELECT low FROM IschemicStrokeEncounter.relevantPeriod, SELECT high FROM IschemicStrokeEncounter.relevantPeriod))
/*
