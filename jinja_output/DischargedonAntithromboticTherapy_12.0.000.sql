...
*/
SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM urn:oid:2.16.840.1.113883.3.117.1.7.1.424 AS NonElectiveEncounter) WHERE (((NonElectiveEncounter.relevantPeriod.high - NonElectiveEncounter.relevantPeriod.low) <= 120) AND (NonElectiveEncounter.relevantPeriod.high IN @Measurement_Period)) AS NonElectiveEncounter, /*{Operator: _macros_sparksql.Exists with children: [SELECT * FROM (NonElectiveEncounter.diagnoses AS Diagnosis) WHERE ((Diagnosis.rank = 1) AND (IN Diagnosis.code OR IN Diagnosis.code))]}*/) AS AllStrokeEncounter) WHERE (/*{Operator: _macros_sparksql.CalculateAgeAt with children: [{Operator: _macros_sparksql.ToDate with children: [SELECT birthDatetime FROM SELECT * FROM Patient]}, {Operator: _macros_sparksql.DateFrom with children: [SELECT low FROM AllStrokeEncounter.relevantPeriod]}]}*/ >= 18) AS EncounterWithAge, /*{Operator: _macros_sparksql.Exists with children: [SELECT * FROM (EncounterWithAge.diagnoses AS Diagnosis) WHERE (IN Diagnosis.code AND (Diagnosis.rank = 1))]}*/)
/*
	// DischargedonAntithromboticTherapy lines [34:1-35:50]
	define "Initial Population":
	  TJC."Encounter with Principal Diagnosis and Age"
*/
SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM urn:oid:2.16.840.1.113883.3.117.1.7.1.424 AS NonElectiveEncounter) WHERE (((NonElectiveEncounter.relevantPeriod.high - NonElectiveEncounter.relevantPeriod.low) <= 120) AND (NonElectiveEncounter.relevantPeriod.high IN @Measurement_Period)) AS NonElectiveEncounter, /*{Operator: _macros_sparksql.Exists with children: [SELECT * FROM (NonElectiveEncounter.diagnoses AS Diagnosis) WHERE ((Diagnosis.rank = 1) AND (IN Diagnosis.code OR IN Diagnosis.code))]}*/) AS AllStrokeEncounter) WHERE (/*{Operator: _macros_sparksql.CalculateAgeAt with children: [{Operator: _macros_sparksql.ToDate with children: [SELECT birthDatetime FROM SELECT * FROM Patient]}, {Operator: _macros_sparksql.DateFrom with children: [SELECT low FROM AllStrokeEncounter.relevantPeriod]}]}*/ >= 18)
/*
...
*/
SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM urn:oid:2.16.840.1.113883.3.117.1.7.1.424 AS NonElectiveEncounter) WHERE (((NonElectiveEncounter.relevantPeriod.high - NonElectiveEncounter.relevantPeriod.low) <= 120) AND (NonElectiveEncounter.relevantPeriod.high IN @Measurement_Period)) AS NonElectiveEncounter, /*{Operator: _macros_sparksql.Exists with children: [SELECT * FROM (NonElectiveEncounter.diagnoses AS Diagnosis) WHERE ((Diagnosis.rank = 1) AND (IN Diagnosis.code OR IN Diagnosis.code))]}*/) AS AllStrokeEncounter) WHERE (/*{Operator: _macros_sparksql.CalculateAgeAt with children: [{Operator: _macros_sparksql.ToDate with children: [SELECT birthDatetime FROM SELECT * FROM Patient]}, {Operator: _macros_sparksql.DateFrom with children: [SELECT low FROM AllStrokeEncounter.relevantPeriod]}]}*/ >= 18) AS EncounterWithAge, /*{Operator: _macros_sparksql.Exists with children: [SELECT * FROM (EncounterWithAge.diagnoses AS Diagnosis) WHERE (IN Diagnosis.code AND (Diagnosis.rank = 1))]}*/) AS IschemicStrokeEncounter) WHERE ((((IN IschemicStrokeEncounter.dischargeDisposition OR IN IschemicStrokeEncounter.dischargeDisposition) OR IN IschemicStrokeEncounter.dischargeDisposition) OR IN IschemicStrokeEncounter.dischargeDisposition) OR IN IschemicStrokeEncounter.dischargeDisposition) UNION SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM urn:oid:2.16.840.1.113883.3.117.1.7.1.424 AS NonElectiveEncounter) WHERE (((NonElectiveEncounter.relevantPeriod.high - NonElectiveEncounter.relevantPeriod.low) <= 120) AND (NonElectiveEncounter.relevantPeriod.high IN @Measurement_Period)) AS NonElectiveEncounter, /*{Operator: _macros_sparksql.Exists with children: [SELECT * FROM (NonElectiveEncounter.diagnoses AS Diagnosis) WHERE ((Diagnosis.rank = 1) AND (IN Diagnosis.code OR IN Diagnosis.code))]}*/) AS AllStrokeEncounter) WHERE (/*{Operator: _macros_sparksql.CalculateAgeAt with children: [{Operator: _macros_sparksql.ToDate with children: [SELECT birthDatetime FROM SELECT * FROM Patient]}, {Operator: _macros_sparksql.DateFrom with children: [SELECT low FROM AllStrokeEncounter.relevantPeriod]}]}*/ >= 18) AS EncounterWithAge, /*{Operator: _macros_sparksql.Exists with children: [SELECT * FROM (EncounterWithAge.diagnoses AS Diagnosis) WHERE (IN Diagnosis.code AND (Diagnosis.rank = 1))]}*/) AS IschemicStrokeEncounter, WITH /*{Operator: _macros_sparksql.As with children: [SELECT * FROM urn:oid:1.3.6.1.4.1.33895.1.3.0.45,  TypeSpecifier operator: <ListTypeSpecifier> with children:[{Operator: _macros_sparksql.ChoiceTypeSpecifier with children: [ TypeSpecifier operator: <NamedTypeSpecifier> with children:[],  TypeSpecifier operator: <NamedTypeSpecifier> with children:[]]}]]}*/ UNION /*{Operator: _macros_sparksql.As with children: [SELECT * FROM urn:oid:1.3.6.1.4.1.33895.1.3.0.45,  TypeSpecifier operator: <ListTypeSpecifier> with children:[{Operator: _macros_sparksql.ChoiceTypeSpecifier with children: [ TypeSpecifier operator: <NamedTypeSpecifier> with children:[],  TypeSpecifier operator: <NamedTypeSpecifier> with children:[]]}]]}*/ AS (/*{Operator: _macros_sparksql.Coalesce with children: [SELECT low FROM {Operator: _macros_sparksql.If with children: [{Operator: _macros_sparksql.Not with children: [{Operator: _macros_sparksql.IsNull with children: [ComfortMeasure.relevantDatetime]}]}, {Operator: _macros_sparksql.Interval with children: [ComfortMeasure.relevantDatetime, ComfortMeasure.relevantDatetime]}, {Operator: _macros_sparksql.If with children: [{Operator: _macros_sparksql.Not with children: [{Operator: _macros_sparksql.IsNull with children: [ComfortMeasure.relevantPeriod]}]}, ComfortMeasure.relevantPeriod, {Operator: _macros_sparksql.As with children: [{Operator: _macros_sparksql.Null with children: []},  TypeSpecifier operator: <IntervalTypeSpecifier> with children:[ TypeSpecifier operator: <NamedTypeSpecifier> with children:[]]]}]}]}, ComfortMeasure.authorDatetime]}*/ IN LET SELECT * FROM (SELECT * FROM urn:oid:2.16.840.1.113762.1.4.1111.143 AS LastObs) WHERE ((LastObs.relevantPeriod.high IN /*{Operator: _macros_sparksql.Interval with children: [(Visit.relevantPeriod.low - {Operator: _macros_sparksql.Quantity with children: []}), Visit.relevantPeriod.low]}*/) AND /*{Operator: _macros_sparksql.Not with children: [{Operator: _macros_sparksql.IsNull with children: [Visit.relevantPeriod.low]}]}*/) ORDER BY relevantPeriod.high ASC, SELECT low FROM SELECT relevantPeriod FROM ObsVisit, SELECT * FROM (SELECT * FROM urn:oid:2.16.840.1.113883.3.117.1.7.1.292 AS LastED) WHERE ((LastED.relevantPeriod.high IN /*{Operator: _macros_sparksql.Interval with children: [(VisitStart - {Operator: _macros_sparksql.Quantity with children: []}), VisitStart]}*/) AND /*{Operator: _macros_sparksql.Not with children: [{Operator: _macros_sparksql.IsNull with children: [VisitStart]}]}*/) ORDER BY relevantPeriod.high ASCSELECT /*{Operator: _macros_sparksql.Interval with children: [{Operator: _macros_sparksql.Coalesce with children: [SELECT low FROM SELECT relevantPeriod FROM EDVisit, VisitStart]}, SELECT high FROM Visit.relevantPeriod]}*/ FROM (/*{Operator: _macros_sparksql.AliasRef with children: []}*/ AS Visit)))
/*
