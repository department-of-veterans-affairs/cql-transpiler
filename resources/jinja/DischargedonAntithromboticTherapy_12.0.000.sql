...
*/
{% macro DischargedonAntithromboticTherapySDE_Ethnicity(state) %}{{ printOperator(state, { 'operator': ExpressionDef, 'context': 'Patient', 'name': 'SDE Ethnicity', 'child': { 'operator': Retrieve, 'modelType': 'urn:healthit-gov:qdm:v5_6', 'templateId': none, 'resultTypeLabel': 'Patient Characteristic Ethnicity', 'codeComparator': 'in', 'codeProperty': 'code', 'child': none, 'valueSet': { 'operator': ValueSetRef, 'reference': Ethnicity } } }) }}{% endmacro %}
...
*/
{% macro DischargedonAntithromboticTherapySDE_Payer(state) %}{{ printOperator(state, { 'operator': ExpressionDef, 'context': 'Patient', 'name': 'SDE Payer', 'child': { 'operator': Retrieve, 'modelType': 'urn:healthit-gov:qdm:v5_6', 'templateId': none, 'resultTypeLabel': 'Patient Characteristic Payer', 'codeComparator': 'in', 'codeProperty': 'code', 'child': none, 'valueSet': { 'operator': ValueSetRef, 'reference': Payer } } }) }}{% endmacro %}
...
*/
{% macro DischargedonAntithromboticTherapySDE_Race(state) %}{{ printOperator(state, { 'operator': ExpressionDef, 'context': 'Patient', 'name': 'SDE Race', 'child': { 'operator': Retrieve, 'modelType': 'urn:healthit-gov:qdm:v5_6', 'templateId': none, 'resultTypeLabel': 'Patient Characteristic Race', 'codeComparator': 'in', 'codeProperty': 'code', 'child': none, 'valueSet': { 'operator': ValueSetRef, 'reference': Race } } }) }}{% endmacro %}
...
*/
{% macro DischargedonAntithromboticTherapySDE_Sex(state) %}{{ printOperator(state, { 'operator': ExpressionDef, 'context': 'Patient', 'name': 'SDE Sex', 'child': { 'operator': Retrieve, 'modelType': 'urn:healthit-gov:qdm:v5_6', 'templateId': none, 'resultTypeLabel': 'Patient Characteristic Sex', 'codeComparator': 'in', 'codeProperty': 'code', 'child': none, 'valueSet': { 'operator': ValueSetRef, 'reference': ONC_Administrative_Sex } } }) }}{% endmacro %}
...
*/
{% macro DischargedonAntithromboticTherapyDenominator(state) %}{{ printOperator(state, { 'operator': ExpressionDef, 'context': 'Patient', 'name': 'Denominator', 'child': { 'operator': ExpressionRef, 'reference': TJC.TJCOverallIschemic_Stroke_Encounter } }) }}{% endmacro %}
...
*/
{% macro DischargedonAntithromboticTherapyInitial_Population(state) %}{{ printOperator(state, { 'operator': ExpressionDef, 'context': 'Patient', 'name': 'Initial Population', 'child': { 'operator': ExpressionRef, 'reference': TJC.TJCOverallEncounter_with_Principal_Diagnosis_and_Age } }) }}{% endmacro %}
...
*/
{% macro DischargedonAntithromboticTherapyDenominator_Exclusions(state) %}{{ printOperator(state, { 'operator': ExpressionDef, 'context': 'Patient', 'name': 'Denominator Exclusions', 'child': { 'operator': Union, 'children': [{ 'operator': ExpressionRef, 'reference': TJC.TJCOverallIschemic_Stroke_Encounters_with_Discharge_Disposition }, { 'operator': ExpressionRef, 'reference': TJC.TJCOverallEncounter_with_Comfort_Measures_during_Hospitalization }] } }) }}{% endmacro %}
...
*/
{% macro DischargedonAntithromboticTherapyNumerator(state) %}{{ printOperator(state, { 'operator': ExpressionDef, 'context': 'Patient', 'name': 'Numerator', 'child': { 'operator': Query, 'where': none, 'returnClause': none, 'sortClause': none, 'children': [{ 'operator': AliasedQuerySource, 'alias': 'IschemicStrokeEncounter', 'child': { 'operator': ExpressionRef, 'reference': TJC.TJCOverallIschemic_Stroke_Encounter } }, { 'operator': With, 'alias': 'DischargeAntithrombotic', 'child': { 'operator': Retrieve, 'modelType': 'urn:healthit-gov:qdm:v5_6', 'templateId': 'PositiveMedicationDischarge', 'resultTypeLabel': 'Medication, Discharge', 'codeComparator': 'in', 'codeProperty': 'code', 'child': none, 'valueSet': { 'operator': ValueSetRef, 'reference': Antithrombotic_Therapy_for_Ischemic_Stroke } }, 'suchThat': { 'operator': InInterval, 'left': { 'operator': Property, 'scope': 'DischargeAntithrombotic', 'path': 'authorDatetime', 'child': none }, 'right': { 'operator': Property, 'scope': 'IschemicStrokeEncounter', 'path': 'relevantPeriod', 'child': none } } }], 'letClauseList': [] } }) }}{% endmacro %}
...
*/
{% macro DischargedonAntithromboticTherapyEncounter_with_Documented_Reason_for_No_Antithrombotic_At_Discharge(state) %}{{ printOperator(state, { 'operator': ExpressionDef, 'context': 'Patient', 'name': 'Encounter with Documented Reason for No Antithrombotic At Discharge', 'child': { 'operator': Query, 'where': none, 'returnClause': none, 'sortClause': none, 'children': [{ 'operator': AliasedQuerySource, 'alias': 'IschemicStrokeEncounter', 'child': { 'operator': ExpressionRef, 'reference': TJC.TJCOverallIschemic_Stroke_Encounter } }, { 'operator': With, 'alias': 'NoDischargeAntithrombotic', 'child': { 'operator': ExpressionRef, 'reference': DischargedonAntithromboticTherapyReason_for_Not_Giving_Antithrombotic_at_Discharge }, 'suchThat': { 'operator': InInterval, 'left': { 'operator': Property, 'scope': 'NoDischargeAntithrombotic', 'path': 'authorDatetime', 'child': none }, 'right': { 'operator': Property, 'scope': 'IschemicStrokeEncounter', 'path': 'relevantPeriod', 'child': none } } }], 'letClauseList': [] } }) }}{% endmacro %}
