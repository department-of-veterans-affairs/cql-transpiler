...
*/
{% set MATGlobalCommonFunctionsEmergency_Department_Visit = 'urn:oid:2.16.840.1.113883.3.117.1.7.1.292' %}
/*
	// MATGlobalCommonFunctions lines [6:1-6:71]
	valueset "Encounter Inpatient": 'urn:oid:2.16.840.1.113883.3.666.5.307' 
*/
{% set MATGlobalCommonFunctionsEncounter_Inpatient = 'urn:oid:2.16.840.1.113883.3.666.5.307' %}
/*
	// MATGlobalCommonFunctions lines [7:1-7:72]
	valueset "Intensive Care Unit": 'urn:oid:2.16.840.1.113762.1.4.1029.206' 
*/
{% set MATGlobalCommonFunctionsIntensive_Care_Unit = 'urn:oid:2.16.840.1.113762.1.4.1029.206' %}
/*
	// MATGlobalCommonFunctions lines [8:1-8:73]
	valueset "Observation Services": 'urn:oid:2.16.840.1.113762.1.4.1111.143' 
*/
{% set MATGlobalCommonFunctionsObservation_Services = 'urn:oid:2.16.840.1.113762.1.4.1111.143' %}
/*
	// MATGlobalCommonFunctions lines [9:1-9:78]
	valueset "Outpatient Surgery Service": 'urn:oid:2.16.840.1.113762.1.4.1110.38' 
*/
{% set MATGlobalCommonFunctionsOutpatient_Surgery_Service = 'urn:oid:2.16.840.1.113762.1.4.1110.38' %}
/*
...
*/
{% macro MATGlobalCommonFunctionsED_Encounter(state) %}{{ printOperator(state, { 'operator': ExpressionDef, 'context': 'Patient', 'name': 'ED Encounter', 'child': { 'operator': Retrieve, 'modelType': 'urn:healthit-gov:qdm:v5_6', 'templateId': 'PositiveEncounterPerformed', 'resultTypeLabel': 'Encounter, Performed', 'codeComparator': 'in', 'codeProperty': 'code', 'child': none, 'valueSet': { 'operator': ValueSetRef, 'reference': MATGlobalCommonFunctionsEmergency_Department_Visit } } }) }}{% endmacro %}
...
*/
{% macro MATGlobalCommonFunctionsInpatient_Encounter(state) %}{{ printOperator(state, { 'operator': ExpressionDef, 'context': 'Patient', 'name': 'Inpatient Encounter', 'child': { 'operator': Query, 'where': { 'operator': And, 'left': { 'operator': LessOrEqual, 'left': { 'operator': FunctionRef, 'reference': MATGlobalCommonFunctionsLengthInDays, 'children': [{ 'operator': Property, 'scope': 'EncounterInpatient', 'path': 'relevantPeriod', 'child': none }] }, 'right': { 'operator': Literal, 'type': 'Integer', 'value': '120' } }, 'right': { 'operator': InInterval, 'left': { 'operator': End, 'child': { 'operator': Property, 'scope': 'EncounterInpatient', 'path': 'relevantPeriod', 'child': none } }, 'right': { 'operator': ParameterRef, 'name': 'Measurement_Period' } } }, 'returnClause': none, 'sortClause': none, 'children': [{ 'operator': AliasedQuerySource, 'alias': 'EncounterInpatient', 'child': { 'operator': Retrieve, 'modelType': 'urn:healthit-gov:qdm:v5_6', 'templateId': 'PositiveEncounterPerformed', 'resultTypeLabel': 'Encounter, Performed', 'codeComparator': 'in', 'codeProperty': 'code', 'child': none, 'valueSet': { 'operator': ValueSetRef, 'reference': MATGlobalCommonFunctionsEncounter_Inpatient } } }], 'letClauseList': [] } }) }}{% endmacro %}
...
*/
{% macro MATGlobalCommonFunctionsHospitalization(state) %}{{ printOperator(state, { 'operator': FunctionDef, 'context': 'Patient', 'name': 'Hospitalization', 'child': { 'operator': Query, 'where': none, 'returnClause': { 'operator': ReturnClause, 'children': [{ 'operator': Interval, 'high': { 'operator': End, 'child': { 'operator': Property, 'scope': 'Visit', 'path': 'relevantPeriod', 'child': none } }, 'highClosedExpression': none, 'low': { 'operator': Coalesce, 'children': [{ 'operator': Start, 'child': { 'operator': Property, 'scope': none, 'path': 'relevantPeriod', 'child': { 'operator': QueryLetRef, 'name': 'EDVisit' } } }, { 'operator': Start, 'child': { 'operator': Property, 'scope': 'Visit', 'path': 'relevantPeriod', 'child': none } }] }, 'lowClosedExpression': none }] }, 'sortClause': none, 'children': [{ 'operator': AliasedQuerySource, 'alias': 'Visit', 'child': { 'operator': OperandRef, 'reference': 'Encounter' } }], 'letClauseList': [{ 'operator': LetClause, 'child': { 'operator': Query, 'where': { 'operator': And, 'left': { 'operator': InInterval, 'left': { 'operator': End, 'child': { 'operator': Property, 'scope': 'LastED', 'path': 'relevantPeriod', 'child': none } }, 'right': { 'operator': Interval, 'high': { 'operator': Start, 'child': { 'operator': Property, 'scope': 'Visit', 'path': 'relevantPeriod', 'child': none } }, 'highClosedExpression': none, 'low': { 'operator': Subtract, 'left': { 'operator': Start, 'child': { 'operator': Property, 'scope': 'Visit', 'path': 'relevantPeriod', 'child': none } }, 'right': { 'operator': Quantity, 'unit': 'hour', 'value': '1' } }, 'lowClosedExpression': none } }, 'right': { 'operator': Not, 'child': { 'operator': IsNull, 'child': { 'operator': Start, 'child': { 'operator': Property, 'scope': 'Visit', 'path': 'relevantPeriod', 'child': none } } } } }, 'returnClause': none, 'sortClause': { 'operator': SortClause, 'children': [{ 'operator': ByExpression, 'direction': 'ASC', 'child': { 'operator': End, 'child': { 'operator': IdentifierRef, 'name': 'relevantPeriod', 'children': [] } } }] }, 'children': [{ 'operator': AliasedQuerySource, 'alias': 'LastED', 'child': { 'operator': Retrieve, 'modelType': 'urn:healthit-gov:qdm:v5_6', 'templateId': 'PositiveEncounterPerformed', 'resultTypeLabel': 'Encounter, Performed', 'codeComparator': 'in', 'codeProperty': 'code', 'child': none, 'valueSet': { 'operator': ValueSetRef, 'reference': MATGlobalCommonFunctionsEmergency_Department_Visit } } }], 'letClauseList': [] } }] }, 'typeSpecifier': { 'operator': IntervalTypeSpecifier, 'children': [{ 'operator': NamedTypeSpecifier, 'name': '{urn:hl7-org:elm-types:r1}DateTime', 'children': [] }] }, 'operators': [{ 'operator': OperandDef, 'name': 'Encounter', 'children': [{ 'operator': NamedTypeSpecifier, 'name': '{urn:healthit-gov:qdm:v5_6}PositiveEncounterPerformed', 'children': [] }] }] }) }}{% endmacro %}
/*
...
*/
{% macro MATGlobalCommonFunctionsHospitalizationWithObservationAndOutpatientSurgeryService(state) %}{{ printOperator(state, { 'operator': FunctionDef, 'context': 'Patient', 'name': 'HospitalizationWithObservationAndOutpatientSurgeryService', 'child': { 'operator': Query, 'where': none, 'returnClause': { 'operator': ReturnClause, 'children': [{ 'operator': Interval, 'high': { 'operator': End, 'child': { 'operator': Property, 'scope': 'Visit', 'path': 'relevantPeriod', 'child': none } }, 'highClosedExpression': none, 'low': { 'operator': Coalesce, 'children': [{ 'operator': Start, 'child': { 'operator': Property, 'scope': none, 'path': 'relevantPeriod', 'child': { 'operator': QueryLetRef, 'name': 'OutpatientSurgeryVisit' } } }, { 'operator': QueryLetRef, 'name': 'VisitStartWithED' }] }, 'lowClosedExpression': none }] }, 'sortClause': none, 'children': [{ 'operator': AliasedQuerySource, 'alias': 'Visit', 'child': { 'operator': OperandRef, 'reference': 'Encounter' } }, { 'operator': Coalesce, 'children': [{ 'operator': Start, 'child': { 'operator': Property, 'scope': none, 'path': 'relevantPeriod', 'child': { 'operator': QueryLetRef, 'name': 'ObsVisit' } } }, { 'operator': Start, 'child': { 'operator': Property, 'scope': 'Visit', 'path': 'relevantPeriod', 'child': none } }] }, { 'operator': Coalesce, 'children': [{ 'operator': Start, 'child': { 'operator': Property, 'scope': none, 'path': 'relevantPeriod', 'child': { 'operator': QueryLetRef, 'name': 'EDVisit' } } }, { 'operator': QueryLetRef, 'name': 'VisitStart' }] }], 'letClauseList': [{ 'operator': LetClause, 'child': { 'operator': Query, 'where': { 'operator': And, 'left': { 'operator': InInterval, 'left': { 'operator': End, 'child': { 'operator': Property, 'scope': 'LastObs', 'path': 'relevantPeriod', 'child': none } }, 'right': { 'operator': Interval, 'high': { 'operator': Start, 'child': { 'operator': Property, 'scope': 'Visit', 'path': 'relevantPeriod', 'child': none } }, 'highClosedExpression': none, 'low': { 'operator': Subtract, 'left': { 'operator': Start, 'child': { 'operator': Property, 'scope': 'Visit', 'path': 'relevantPeriod', 'child': none } }, 'right': { 'operator': Quantity, 'unit': 'hour', 'value': '1' } }, 'lowClosedExpression': none } }, 'right': { 'operator': Not, 'child': { 'operator': IsNull, 'child': { 'operator': Start, 'child': { 'operator': Property, 'scope': 'Visit', 'path': 'relevantPeriod', 'child': none } } } } }, 'returnClause': none, 'sortClause': { 'operator': SortClause, 'children': [{ 'operator': ByExpression, 'direction': 'ASC', 'child': { 'operator': End, 'child': { 'operator': IdentifierRef, 'name': 'relevantPeriod', 'children': [] } } }] }, 'children': [{ 'operator': AliasedQuerySource, 'alias': 'LastObs', 'child': { 'operator': Retrieve, 'modelType': 'urn:healthit-gov:qdm:v5_6', 'templateId': 'PositiveEncounterPerformed', 'resultTypeLabel': 'Encounter, Performed', 'codeComparator': 'in', 'codeProperty': 'code', 'child': none, 'valueSet': { 'operator': ValueSetRef, 'reference': MATGlobalCommonFunctionsObservation_Services } } }], 'letClauseList': [] } }, { 'operator': LetClause, 'child': { 'operator': Query, 'where': { 'operator': And, 'left': { 'operator': InInterval, 'left': { 'operator': End, 'child': { 'operator': Property, 'scope': 'LastED', 'path': 'relevantPeriod', 'child': none } }, 'right': { 'operator': Interval, 'high': { 'operator': QueryLetRef, 'name': 'VisitStart' }, 'highClosedExpression': none, 'low': { 'operator': Subtract, 'left': { 'operator': QueryLetRef, 'name': 'VisitStart' }, 'right': { 'operator': Quantity, 'unit': 'hour', 'value': '1' } }, 'lowClosedExpression': none } }, 'right': { 'operator': Not, 'child': { 'operator': IsNull, 'child': { 'operator': QueryLetRef, 'name': 'VisitStart' } } } }, 'returnClause': none, 'sortClause': { 'operator': SortClause, 'children': [{ 'operator': ByExpression, 'direction': 'ASC', 'child': { 'operator': End, 'child': { 'operator': IdentifierRef, 'name': 'relevantPeriod', 'children': [] } } }] }, 'children': [{ 'operator': AliasedQuerySource, 'alias': 'LastED', 'child': { 'operator': Retrieve, 'modelType': 'urn:healthit-gov:qdm:v5_6', 'templateId': 'PositiveEncounterPerformed', 'resultTypeLabel': 'Encounter, Performed', 'codeComparator': 'in', 'codeProperty': 'code', 'child': none, 'valueSet': { 'operator': ValueSetRef, 'reference': MATGlobalCommonFunctionsEmergency_Department_Visit } } }], 'letClauseList': [] } }, { 'operator': LetClause, 'child': { 'operator': Query, 'where': { 'operator': And, 'left': { 'operator': InInterval, 'left': { 'operator': End, 'child': { 'operator': Property, 'scope': 'LastSurgeryOP', 'path': 'relevantPeriod', 'child': none } }, 'right': { 'operator': Interval, 'high': { 'operator': QueryLetRef, 'name': 'VisitStartWithED' }, 'highClosedExpression': none, 'low': { 'operator': Subtract, 'left': { 'operator': QueryLetRef, 'name': 'VisitStartWithED' }, 'right': { 'operator': Quantity, 'unit': 'hour', 'value': '1' } }, 'lowClosedExpression': none } }, 'right': { 'operator': Not, 'child': { 'operator': IsNull, 'child': { 'operator': QueryLetRef, 'name': 'VisitStartWithED' } } } }, 'returnClause': none, 'sortClause': { 'operator': SortClause, 'children': [{ 'operator': ByExpression, 'direction': 'ASC', 'child': { 'operator': End, 'child': { 'operator': IdentifierRef, 'name': 'relevantPeriod', 'children': [] } } }] }, 'children': [{ 'operator': AliasedQuerySource, 'alias': 'LastSurgeryOP', 'child': { 'operator': Retrieve, 'modelType': 'urn:healthit-gov:qdm:v5_6', 'templateId': 'PositiveEncounterPerformed', 'resultTypeLabel': 'Encounter, Performed', 'codeComparator': 'in', 'codeProperty': 'code', 'child': none, 'valueSet': { 'operator': ValueSetRef, 'reference': MATGlobalCommonFunctionsOutpatient_Surgery_Service } } }], 'letClauseList': [] } }] }, 'typeSpecifier': { 'operator': IntervalTypeSpecifier, 'children': [{ 'operator': NamedTypeSpecifier, 'name': '{urn:hl7-org:elm-types:r1}DateTime', 'children': [] }] }, 'operators': [{ 'operator': OperandDef, 'name': 'Encounter', 'children': [{ 'operator': NamedTypeSpecifier, 'name': '{urn:healthit-gov:qdm:v5_6}PositiveEncounterPerformed', 'children': [] }] }] }) }}{% endmacro %}
/*
...
*/
{% macro MATGlobalCommonFunctionsHospitalizationWithObservation(state) %}{{ printOperator(state, { 'operator': FunctionDef, 'context': 'Patient', 'name': 'HospitalizationWithObservation', 'child': { 'operator': Query, 'where': none, 'returnClause': { 'operator': ReturnClause, 'children': [{ 'operator': Interval, 'high': { 'operator': End, 'child': { 'operator': Property, 'scope': 'Visit', 'path': 'relevantPeriod', 'child': none } }, 'highClosedExpression': none, 'low': { 'operator': Coalesce, 'children': [{ 'operator': Start, 'child': { 'operator': Property, 'scope': none, 'path': 'relevantPeriod', 'child': { 'operator': QueryLetRef, 'name': 'EDVisit' } } }, { 'operator': QueryLetRef, 'name': 'VisitStart' }] }, 'lowClosedExpression': none }] }, 'sortClause': none, 'children': [{ 'operator': AliasedQuerySource, 'alias': 'Visit', 'child': { 'operator': OperandRef, 'reference': 'Encounter' } }, { 'operator': Coalesce, 'children': [{ 'operator': Start, 'child': { 'operator': Property, 'scope': none, 'path': 'relevantPeriod', 'child': { 'operator': QueryLetRef, 'name': 'ObsVisit' } } }, { 'operator': Start, 'child': { 'operator': Property, 'scope': 'Visit', 'path': 'relevantPeriod', 'child': none } }] }], 'letClauseList': [{ 'operator': LetClause, 'child': { 'operator': Query, 'where': { 'operator': And, 'left': { 'operator': InInterval, 'left': { 'operator': End, 'child': { 'operator': Property, 'scope': 'LastObs', 'path': 'relevantPeriod', 'child': none } }, 'right': { 'operator': Interval, 'high': { 'operator': Start, 'child': { 'operator': Property, 'scope': 'Visit', 'path': 'relevantPeriod', 'child': none } }, 'highClosedExpression': none, 'low': { 'operator': Subtract, 'left': { 'operator': Start, 'child': { 'operator': Property, 'scope': 'Visit', 'path': 'relevantPeriod', 'child': none } }, 'right': { 'operator': Quantity, 'unit': 'hour', 'value': '1' } }, 'lowClosedExpression': none } }, 'right': { 'operator': Not, 'child': { 'operator': IsNull, 'child': { 'operator': Start, 'child': { 'operator': Property, 'scope': 'Visit', 'path': 'relevantPeriod', 'child': none } } } } }, 'returnClause': none, 'sortClause': { 'operator': SortClause, 'children': [{ 'operator': ByExpression, 'direction': 'ASC', 'child': { 'operator': End, 'child': { 'operator': IdentifierRef, 'name': 'relevantPeriod', 'children': [] } } }] }, 'children': [{ 'operator': AliasedQuerySource, 'alias': 'LastObs', 'child': { 'operator': Retrieve, 'modelType': 'urn:healthit-gov:qdm:v5_6', 'templateId': 'PositiveEncounterPerformed', 'resultTypeLabel': 'Encounter, Performed', 'codeComparator': 'in', 'codeProperty': 'code', 'child': none, 'valueSet': { 'operator': ValueSetRef, 'reference': MATGlobalCommonFunctionsObservation_Services } } }], 'letClauseList': [] } }, { 'operator': LetClause, 'child': { 'operator': Query, 'where': { 'operator': And, 'left': { 'operator': InInterval, 'left': { 'operator': End, 'child': { 'operator': Property, 'scope': 'LastED', 'path': 'relevantPeriod', 'child': none } }, 'right': { 'operator': Interval, 'high': { 'operator': QueryLetRef, 'name': 'VisitStart' }, 'highClosedExpression': none, 'low': { 'operator': Subtract, 'left': { 'operator': QueryLetRef, 'name': 'VisitStart' }, 'right': { 'operator': Quantity, 'unit': 'hour', 'value': '1' } }, 'lowClosedExpression': none } }, 'right': { 'operator': Not, 'child': { 'operator': IsNull, 'child': { 'operator': QueryLetRef, 'name': 'VisitStart' } } } }, 'returnClause': none, 'sortClause': { 'operator': SortClause, 'children': [{ 'operator': ByExpression, 'direction': 'ASC', 'child': { 'operator': End, 'child': { 'operator': IdentifierRef, 'name': 'relevantPeriod', 'children': [] } } }] }, 'children': [{ 'operator': AliasedQuerySource, 'alias': 'LastED', 'child': { 'operator': Retrieve, 'modelType': 'urn:healthit-gov:qdm:v5_6', 'templateId': 'PositiveEncounterPerformed', 'resultTypeLabel': 'Encounter, Performed', 'codeComparator': 'in', 'codeProperty': 'code', 'child': none, 'valueSet': { 'operator': ValueSetRef, 'reference': MATGlobalCommonFunctionsEmergency_Department_Visit } } }], 'letClauseList': [] } }] }, 'typeSpecifier': { 'operator': IntervalTypeSpecifier, 'children': [{ 'operator': NamedTypeSpecifier, 'name': '{urn:hl7-org:elm-types:r1}DateTime', 'children': [] }] }, 'operators': [{ 'operator': OperandDef, 'name': 'Encounter', 'children': [{ 'operator': NamedTypeSpecifier, 'name': '{urn:healthit-gov:qdm:v5_6}PositiveEncounterPerformed', 'children': [] }] }] }) }}{% endmacro %}
/*
