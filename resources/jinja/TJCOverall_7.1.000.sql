...
*/
{% macro TJCOverallIntervention_Comfort_Measures(state) %}{{ printOperator(state, { 'operator': ExpressionDef, 'context': 'Patient', 'name': 'Intervention Comfort Measures', 'child': { 'operator': Union, 'children': [{ 'operator': As, 'child': { 'operator': Retrieve, 'modelType': 'urn:healthit-gov:qdm:v5_6', 'templateId': 'PositiveInterventionOrder', 'resultTypeLabel': 'Intervention, Order', 'codeComparator': 'in', 'codeProperty': 'code', 'child': none, 'valueSet': { 'operator': ValueSetRef, 'reference': Comfort_Measures } }, 'typeSpecifier': { 'operator': ListTypeSpecifier, 'children': [{ 'operator': Unsupported, 'unsupportedOperator': 'ChoiceTypeSpecifier', 'children': [{ 'operator': NamedTypeSpecifier, 'name': '{urn:healthit-gov:qdm:v5_6}PositiveInterventionPerformed', 'children': [] }, { 'operator': NamedTypeSpecifier, 'name': '{urn:healthit-gov:qdm:v5_6}PositiveInterventionOrder', 'children': [] }] }] } }, { 'operator': As, 'child': { 'operator': Retrieve, 'modelType': 'urn:healthit-gov:qdm:v5_6', 'templateId': 'PositiveInterventionPerformed', 'resultTypeLabel': 'Intervention, Performed', 'codeComparator': 'in', 'codeProperty': 'code', 'child': none, 'valueSet': { 'operator': ValueSetRef, 'reference': Comfort_Measures } }, 'typeSpecifier': { 'operator': ListTypeSpecifier, 'children': [{ 'operator': Unsupported, 'unsupportedOperator': 'ChoiceTypeSpecifier', 'children': [{ 'operator': NamedTypeSpecifier, 'name': '{urn:healthit-gov:qdm:v5_6}PositiveInterventionPerformed', 'children': [] }, { 'operator': NamedTypeSpecifier, 'name': '{urn:healthit-gov:qdm:v5_6}PositiveInterventionOrder', 'children': [] }] }] } }] } }) }}{% endmacro %}
...
*/
{% macro TJCOverallNon_Elective_Inpatient_Encounter(state) %}{{ printOperator(state, { 'operator': ExpressionDef, 'context': 'Patient', 'name': 'Non Elective Inpatient Encounter', 'child': { 'operator': Query, 'where': { 'operator': And, 'left': { 'operator': LessOrEqual, 'left': { 'operator': FunctionRef, 'reference': Global.MATGlobalCommonFunctionsLengthInDays, 'children': [{ 'operator': Property, 'scope': 'NonElectiveEncounter', 'path': 'relevantPeriod', 'child': none }] }, 'right': { 'operator': Literal, 'type': 'Integer', 'value': '120' } }, 'right': { 'operator': InInterval, 'left': { 'operator': End, 'child': { 'operator': Property, 'scope': 'NonElectiveEncounter', 'path': 'relevantPeriod', 'child': none } }, 'right': { 'operator': ParameterRef, 'name': 'Measurement_Period' } } }, 'returnClause': none, 'sortClause': none, 'children': [{ 'operator': AliasedQuerySource, 'alias': 'NonElectiveEncounter', 'child': { 'operator': Retrieve, 'modelType': 'urn:healthit-gov:qdm:v5_6', 'templateId': 'PositiveEncounterPerformed', 'resultTypeLabel': 'Encounter, Performed', 'codeComparator': 'in', 'codeProperty': 'code', 'child': none, 'valueSet': { 'operator': ValueSetRef, 'reference': Nonelective_Inpatient_Encounter } } }], 'letClauseList': [] } }) }}{% endmacro %}
...
*/
{% macro TJCOverallIschemic_Stroke_Encounters_with_Discharge_Disposition(state) %}{{ printOperator(state, { 'operator': ExpressionDef, 'context': 'Patient', 'name': 'Ischemic Stroke Encounters with Discharge Disposition', 'child': { 'operator': Query, 'where': { 'operator': Or, 'left': { 'operator': Or, 'left': { 'operator': Or, 'left': { 'operator': Or, 'left': { 'operator': InValueSet, 'child': none, 'valueSetReference': { 'operator': ValueSetRef, 'reference': Discharge_To_Acute_Care_Facility }, 'valueSetExpression': none }, 'right': { 'operator': InValueSet, 'child': none, 'valueSetReference': { 'operator': ValueSetRef, 'reference': Left_Against_Medical_Advice }, 'valueSetExpression': none } }, 'right': { 'operator': InValueSet, 'child': none, 'valueSetReference': { 'operator': ValueSetRef, 'reference': Patient_Expired }, 'valueSetExpression': none } }, 'right': { 'operator': InValueSet, 'child': none, 'valueSetReference': { 'operator': ValueSetRef, 'reference': Discharged_to_Home_for_Hospice_Care }, 'valueSetExpression': none } }, 'right': { 'operator': InValueSet, 'child': none, 'valueSetReference': { 'operator': ValueSetRef, 'reference': Discharged_to_Health_Care_Facility_for_Hospice_Care }, 'valueSetExpression': none } }, 'returnClause': none, 'sortClause': none, 'children': [{ 'operator': AliasedQuerySource, 'alias': 'IschemicStrokeEncounter', 'child': { 'operator': ExpressionRef, 'reference': TJCOverallIschemic_Stroke_Encounter } }], 'letClauseList': [] } }) }}{% endmacro %}
...
*/
{% macro TJCOverallHospitalizationWithObservationLengthofStay(state) %}{{ printOperator(state, { 'operator': FunctionDef, 'context': 'Patient', 'name': 'HospitalizationWithObservationLengthofStay', 'child': { 'operator': FunctionRef, 'reference': Global.MATGlobalCommonFunctionsLengthInDays, 'children': [{ 'operator': FunctionRef, 'reference': Global.MATGlobalCommonFunctionsHospitalizationWithObservation, 'children': [{ 'operator': OperandRef, 'reference': 'Encounter' }] }] }, 'typeSpecifier': { 'operator': Disabled, 'children': [] }, 'operators': [{ 'operator': OperandDef, 'name': 'Encounter', 'children': [{ 'operator': NamedTypeSpecifier, 'name': '{urn:healthit-gov:qdm:v5_6}PositiveEncounterPerformed', 'children': [] }] }] }) }}{% endmacro %}
/*
