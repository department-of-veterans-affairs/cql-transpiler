...
*/
{% macro TJCOverallComfort_Measures() %}urn:oid:1.3.6.1.4.1.33895.1.3.0.45{% endmacro %}
/*
	// TJCOverall lines [8:1-8:87]
	valueset "Discharge To Acute Care Facility": 'urn:oid:2.16.840.1.113883.3.117.1.7.1.87' 
*/
{% macro TJCOverallDischarge_To_Acute_Care_Facility() %}urn:oid:2.16.840.1.113883.3.117.1.7.1.87{% endmacro %}
/*
...
*/
{% macro TJCOverallDischarged_to_Health_Care_Facility_for_Hospice_Care() %}urn:oid:2.16.840.1.113883.3.117.1.7.1.207{% endmacro %}
/*
	// TJCOverall lines [10:1-10:91]
	valueset "Discharged to Home for Hospice Care": 'urn:oid:2.16.840.1.113883.3.117.1.7.1.209' 
*/
{% macro TJCOverallDischarged_to_Home_for_Hospice_Care() %}urn:oid:2.16.840.1.113883.3.117.1.7.1.209{% endmacro %}
/*
	// TJCOverall lines [11:1-11:82]
	valueset "Emergency Department Visit": 'urn:oid:2.16.840.1.113883.3.117.1.7.1.292' 
*/
{% macro TJCOverallEmergency_Department_Visit() %}urn:oid:2.16.840.1.113883.3.117.1.7.1.292{% endmacro %}
/*
	// TJCOverall lines [12:1-12:74]
	valueset "Hemorrhagic Stroke": 'urn:oid:2.16.840.1.113883.3.117.1.7.1.212' 
*/
{% macro TJCOverallHemorrhagic_Stroke() %}urn:oid:2.16.840.1.113883.3.117.1.7.1.212{% endmacro %}
/*
	// TJCOverall lines [13:1-13:71]
	valueset "Ischemic Stroke": 'urn:oid:2.16.840.1.113883.3.117.1.7.1.247' 
*/
{% macro TJCOverallIschemic_Stroke() %}urn:oid:2.16.840.1.113883.3.117.1.7.1.247{% endmacro %}
/*
	// TJCOverall lines [14:1-14:83]
	valueset "Left Against Medical Advice": 'urn:oid:2.16.840.1.113883.3.117.1.7.1.308' 
*/
{% macro TJCOverallLeft_Against_Medical_Advice() %}urn:oid:2.16.840.1.113883.3.117.1.7.1.308{% endmacro %}
/*
	// TJCOverall lines [15:1-15:87]
	valueset "Nonelective Inpatient Encounter": 'urn:oid:2.16.840.1.113883.3.117.1.7.1.424' 
*/
{% macro TJCOverallNonelective_Inpatient_Encounter() %}urn:oid:2.16.840.1.113883.3.117.1.7.1.424{% endmacro %}
/*
	// TJCOverall lines [16:1-16:73]
	valueset "Observation Services": 'urn:oid:2.16.840.1.113762.1.4.1111.143' 
*/
{% macro TJCOverallObservation_Services() %}urn:oid:2.16.840.1.113762.1.4.1111.143{% endmacro %}
/*
	// TJCOverall lines [17:1-17:71]
	valueset "Patient Expired": 'urn:oid:2.16.840.1.113883.3.117.1.7.1.309' 
*/
{% macro TJCOverallPatient_Expired() %}urn:oid:2.16.840.1.113883.3.117.1.7.1.309{% endmacro %}
/*
