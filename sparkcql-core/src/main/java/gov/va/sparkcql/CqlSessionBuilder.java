package gov.va.sparkcql;//package gov.va.sparkcql.pipeline;
//
...
//import gov.va.sparkcql.domain.LibraryPack;
//import gov.va.sparkcql.log.Log;
//import gov.va.sparkcql.cqf.compiler.CompilerFactory;
...
//import gov.va.sparkcql.pipeline.planner.PlannerFactory;
...
//    private LibraryPack explicitLibraryPack;
...
//        defaultBindings(PlannerFactory.class, true);
...
//    }
//
//    public PipelineBuilder withPlan(LibraryPack libraryPack) {
//        this.explicitLibraryPack = libraryPack;
//        return this;
//    }
//
