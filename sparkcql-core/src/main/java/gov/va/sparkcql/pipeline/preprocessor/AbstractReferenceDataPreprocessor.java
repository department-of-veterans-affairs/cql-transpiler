...
public abstract class AbstractReferenceDataPreprocessor implements Preprocessor {

    private final SparkSession spark;
    private final TableResolutionStrategy tableResolutionStrategy;

    @Inject
    public AbstractReferenceDataPreprocessor(SparkFactory sparkFactory, TableResolutionStrategy tableResolutionStrategy) {
