...
class SyntheaDataLoader {
    ...
    public List<String> loadBundles(SyntheticPopulationSize size) {
        switch (size) {
            case PopulationSize10:
                return load10Bundles();
            case PopulationSize1K:
                return load1KBundles();
    ...
    // public Iterator<String> loadResources(String resourceType) {
    //     var files = List.of(
    //             Resources.read("embedded/Aaron697_Brekke496_2fa15bc7-8866-461a-9000-f739e425860a.json"),
    //             Resources.read("embedded/Ali918_Stokes453_f5aa3408-57b3-4c05-a1d3-e4511b4be50e.json"),
    //             Resources.read("embedded/Andreas188_Dare640_f7f63ca8-d282-4520-9a68-3177e2a5db6f.json"),
    ...
    //         @Override
    //         public String next() {
    //             mapper.readValue(files.get(fileIndex));
    //             return null;
    //         }
    //     };
    // }    
