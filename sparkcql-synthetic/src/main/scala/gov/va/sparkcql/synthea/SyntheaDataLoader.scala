...
object SyntheaDataLoader {
  ...
  def loadBundles(size: SampleSize): Seq[String] = {
    size match {
      case SampleSize.SampleSize10 => load10Bundles
      case SampleSize.SampleSize1000 => load1000Bundles
      case SampleSize.SampleSizeNone => Seq()
      case _ => Seq()
    }
  }
